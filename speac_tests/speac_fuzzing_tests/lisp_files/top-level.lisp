...
(defun GET-SPEAC-MIDDLEGROUND (speac-lists grouped-form)
  ...
  (let ((grouped-speac-lists (group-speac-lists speac-lists grouped-form)))
    (loop for phrase in grouped-speac-lists  collect (let ((test (mapcar #'my-last phrase))) (list (run-speac test (average test))(average test))))))

;;;;;
#|(group-speac-lists '((("preparation" "extension" "extension" "extension" "preparation" "extension" "statement" "extension" "extension" "extension" "antecedent" "preparation" "extension" "statement") 1.19)
               (("preparation"  . . .
...
;;;;;
#|(group-them '((a 10000) (a 21000) (a 33000) (a 45000) (a 56000) (a 67000) (a 79000) (a 90000) (a 101000) (a 117000) (a 129000) (a 141000)))
   ((a 10000) (a 21000) (a 33000) (a 45000) (a 56000)
    (a 67000) (a 79000) (a 90000) (a 101000) (a 117000)(a 129000) (a 141000))|#
;;;;;
